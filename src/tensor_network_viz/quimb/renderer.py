"""Public entry points for Quimb plotting."""
...
def plot_quimb_network_2d(
    ...
    *,
    ...
    """Plot a Quimb tensor network in 2D."""
    ...
    return _plot_graph_2d(
        ...
        seed=seed,
        renderer_name="plot_quimb_network_2d",
    )


def plot_quimb_network_3d(
    network: Any,
    *,
    ...
    """Plot a Quimb tensor network in 3D."""
    graph = _build_graph(network)
    return _plot_graph_3d(
        ...
        show_index_labels=show_index_labels,
        seed=seed,
        renderer_name="plot_quimb_network_3d",
    )
